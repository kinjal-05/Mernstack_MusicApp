...
import MusicPlayer from './MusicPlayer'; // Ensure the path is correct
 
// import Contact from './Contact'; // Ensure the path is correct
    ...
    <header className="flex items-center w-full p-4 md:py-2 md:px-6">
      <NavLink to={"/"}>
       ...
       <li className="mx-5 text-lg"><NavLink to={'/*'} className={({isActive}) => isActive ? isActiveStyles : isNotActiveStyles}>Home</NavLink></li>
        ...
        <li className="mx-5 text-lg"><NavLink to={'/home'} className={({isActive}) => isActive ? isActiveStyles : isNotActiveStyles}>Music</NavLink></li>
