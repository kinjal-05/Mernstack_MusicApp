...
// // //             >
// // //               <img
// // //                 src={`https://dummyimage.com/150x150/000/fff&text=${artist}`} // Placeholder image
// // //                 alt={artist}
...
// // //             >
// // //               <img
// // //                 src={`https://dummyimage.com/150x150/000/fff&text=${album}`} // Placeholder image
// // //                 alt={album}
// // //                 className="w-full h-full rounded-lg object-cover mb-2"
// // //               />
...
// // // import React, { useEffect, useState } from "react";
// // // import { getAllArtist, getAllAlbums } from "../api"; // Import the new API functions
// // // import { actionType } from "../Context/reducer";
// // // import { useStateValue } from "../Context/StateProvider";
// // // import Header from "./Header";
// // // import SearchBar from "./SearchBar";
...
// // // const Home = () => {
// // //   const [{ allArtists, allAlbums }, dispatch] = useStateValue(); // Update to include allArtists and allAlbums
// // //   const [loading, setLoading] = useState(true);

// // //   useEffect(() => {
// // //     const fetchArtistsAndAlbums = async () => {
// // //       try {
// // //         const artistsData = await getAllArtist(); // Fetch all artists
// // //         const albumsData = await getAllAlbums(); // Fetch all albums
// // //         dispatch({
// // //           type: actionType.SET_ALL_ARTISTS,
...
// // //               >
// // //                 <img
// // //                   src={artist.imageURL} // Use the actual artist image URL
// // //                   alt={artist.name}
// // //                   className="w-full h-full rounded-lg object-cover mb-2"
// // //                 />
// // //                 <p className="text-base text-headingColor font-semibold">{artist.name}</p>
// // //               </motion.div>
// // //             ))}
// // //           </div>
// // //         )}
...
// // //               >
// // //                 <img
// // //                   src={album.imageURL} // Use the actual album image URL
// // //                   alt={album.name}
// // //                   className="w-full h-full rounded-lg object-cover mb-2"
// // //                 />
// // //                 <p className="text-base text-headingColor font-semibold">{album.name}</p>
// // //               </motion.div>
// // //             ))}
// // //           </div>
// // //         )}
...
// // //         // Check for data existence before dispatching
// // //         if (songsData) {
// // //           dispatch({
// // //             type: actionType.SET_ALL_SONGS,
// // //             allSongs: songsData,
...
// // //   // Helper function to get artist image
// // //   const getArtistImage = (artistName) => {
// // //     const artist = allArtists.find(artist => artist.name === artistName);
// // //     return artist ? artist.imageURL : ""; // Adjust based on your data structure
// // //   };

// // //   // Helper function to get album image
// // //   const getAlbumImage = (albumName) => {
// // //     const album = allAlbums.find(album => album.name === albumName);
// // //     return album ? album.imageURL : ""; // Adjust based on your data structure
// // //   };
...
// // //               >
// // //                 <img
// // //                   src={getArtistImage(artist.name)} // Use actual artist image URL
// // //                   alt={artist.name}
// // //                   className="w-full h-full rounded-lg object-cover mb-2"
// // //                 />
// // //                 <p className="text-base text-headingColor font-semibold">{artist.name}</p>
...
// // //               >
// // //                 <img
// // //                   src={getAlbumImage(album.name)} // Use actual album image URL
// // //                   alt={album.name}
// // //                   className="w-full h-full rounded-lg object-cover mb-2"
// // //                 />
// // //                 <p className="text-base text-headingColor font-semibold">{album.name}</p>
