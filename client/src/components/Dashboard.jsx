  ...
  return (
    <div className="w-full h-auto flex flex-col items-center justify-center bg-primary">
      ...
      <div className="w-[60%] my-2 p-4 flex items-center justify-evenly">
        ...
        <NavLink to={"/dashboard/feedbacks"} className={({ isActive }) => isActive ? isActiveStyles : isNotActiveStyles }> Feedbacks </NavLink>
      </div>
      ...
      <div className="my-4 w-full p-4">
        <Routes>
          ...
          <Route path="/feedbacks" element={<DashboardFeedbacks />} />
        </Routes>
      </div>
    </div>
  );
